...
%endif
Source6: https://releases.llvm.org/release-keys.asc
...
%endif
%else
rm -rf %{buildroot}%{_prefix}/lib/clang/%{maj_ver}/lib/i386-redhat-linux-gnu
%endif
...
* Thu Dec  5 2024 Raven <raven@sysadmins.ws> - 19.1.5-1
- Update to LLVM 19.1.5
- Import SPEC changes from c9-stream
- Import MLIR related stuff from Fedora
